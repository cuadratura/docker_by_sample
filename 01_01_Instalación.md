...
Para Instalar Docker, recurriremos a la documentación oficial de **[Docker Doc](https://docs.docker.com/install/linux/docker-ce/ubuntu/#os-requirements)**.
...
Para Instalar Docker Compose, recurriremos a la documentación oficial de **[Docker Doc](https://docs.docker.com/compose/install/)**.
